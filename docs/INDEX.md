...
This index helps humans and AI quickly understand the AIP documentation
structure. Links point to canonical documents. Items marked **Not yet
documented** are intentional gaps, not missing links.

# Philosophy

- [Vision](philosophy/VISION.md)
- [Product Principles](philosophy/PRODUCT_PRINCIPLES.md)
- Coaching Philosophy — **Not yet documented**
...
- [Coach Dashboard](product/COACH_DASHBOARD.md)
- [Coach Journey](product/COACH_JOURNEY.md)
...
- [FEAT-001 — Manual Sprint Capture](product/FEATURES/feat-001-Manual%20Sprint%20Capture.md) — Approved for local prototype
  ...
  - [FEAT-001.3 — Live Session Workflow](product/FEATURES/feat-001.3-Live-Session-Workflow.md) — Implemented locally; awaiting field validation
...
- [Decision Engine](intelligence/DECISION_ENGINE.md)
- [Decision Log](intelligence/DECISION_LOG.md)
- Athlete Model — **Not yet documented**
- [Movement Assessment](intelligence/MOVEMENT_ASSESSMENT.md)

# Research

- Competitors — **Not yet documented**
- [Future Ideas](research/FUTURE_IDEAS.md)
- Questions — **Not yet documented**
- Field Notes
